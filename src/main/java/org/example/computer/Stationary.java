...
public class Stationary extends Computer{
    private String caseType;

    public Stationary(String name, HardDisk hardDisk, MotherBoard motherBoard, Processor processor, Ram ram, VideoCard videoCard, String caseType) {
